...
public class MyCalendar extends Service {
	...
	public void createEntry(String title, String description, String comments, String sYear, String sMonth, String sDay, 
		...
		String content = "{\"title\":\""+ title + "\",\"description\":\""+ description + "\",\"comments\":\""+ comments +"\"}";
	...
	public HttpResponse createRegular ( @ContentParam String content){
		...
		switch (interval) {
		case "week": 
			createEntry(title, description, comments, Integer.toString(startYear), Integer.toString(startMonth), Integer.toString(startDay), Integer.toString(startHour), Integer.toString(startMinute), Integer.toString(endYear), Integer.toString(endMonth), Integer.toString(endDay), Integer.toString(endHour), Integer.toString(endMinute));
			numbers--;
			...
			while(numbers>(0)){
				...
				createEntry(title, description, comments, sYear, sMonth, sDay, Integer.toString(startHour), Integer.toString(startMinute), eYear, eMonth, eDay, Integer.toString(endHour), Integer.toString(endMinute));
				numbers--;
			}
